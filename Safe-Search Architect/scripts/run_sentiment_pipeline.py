...
from review_critic.analyzer import analyze_reviews
from review_critic.collectors import collect_reviews
from review_critic.douban import collect_douban_reviews
from review_critic.dashboard import render_dashboard
from review_critic.models import write_json, write_jsonl
...
def main() -> None:
    ...
    parser.add_argument("--batch-delay", type=float, default=None, help="Agent batch 之间的等待秒数，默认读取 LLM_BATCH_DELAY 或 8")
